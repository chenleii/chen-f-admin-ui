...
@Component({
  selector: 'app-sys-dictionary-edit',
  templateUrl: './edit.component.html',
})
export class SysDictionaryEditComponent implements OnInit {
  record: any = {};
  sysDictionary: any;
  ...
  ngOnInit(): void {
    ...
    zip(
      ...
      this.cacheService.get('/chen/common/sys/dictionary/item/alain/select/STATUS',
        { mode: 'promise', type: 's', expire: 86400 }),
    ).subscribe(([sysDictionary, typeSelect, statusSelect]: any) => {
  ...
  save(value: any) {
    this.http.put(`/chen/admin/sys/dictionary/${this.record.id}`, value).subscribe(res => {
