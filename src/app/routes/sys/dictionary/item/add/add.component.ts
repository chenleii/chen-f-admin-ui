...
@Component({
  selector: 'app-sys-dictionary-item-add',
  templateUrl: './add.component.html',
})
export class SysDictionaryItemAddComponent implements OnInit {
  record: any = {};
  sysDictionary: any;
  ...
  ngOnInit(): void {
    this.sysDictionaryItem = {};
    this.sysDictionaryItem.sysDictionaryId = this.sysDictionary.id;
    this.sysDictionaryItem.code = this.sysDictionary.code;
    this.sysDictionaryItem.name = this.sysDictionary.name;
    zip(
  ...
  save(value: any) {
    this.http.post(`/chen/admin/sys/dictionary/item`, value).subscribe(res => {
