...
@Component({
  selector: 'app-sys-menu-add',
  templateUrl: './add.component.html',
})
export class SysMenuAddComponent implements OnInit {
  ...
  ngOnInit(): void {
    zip(
      ...
      this.cacheService.get('/chen/common/sys/dictionary/item/alain/select/STATUS',
        { mode: 'promise', type: 's', expire: 86400 }),
    ).subscribe(([allSysMenu, typeSelect, statusSelect]: any) => {
  ...
  save(value: any) {
    this.http.post(`/chen/admin/sys/menu`, value).subscribe(res => {
