...
@Component({
  selector: 'app-sys-parameter-add',
  templateUrl: './add.component.html',
})
export class SysParameterAddComponent implements OnInit {
  ...
  schema: SFSchema = {
    properties: {
      ...
      valueType: {type: 'string', title: '值类型',
        enum: [],
        ui: {
          widget: 'select',
          allowClear: true,
  ...
  save(value: any) {
    this.http.post(`/chen/admin/sys/parameter`, value).subscribe(res => {
